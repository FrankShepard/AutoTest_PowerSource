...
namespace Ingenu_Power
{
	...
	public partial class MainWindow : System.Windows.Window
	{
		...
		/// <summary>
		/// 声明全局变量主窗体的对象，用于在用户子空间中修改主窗体中的元素
		/// </summary>
		...
		/// <summary>
		/// ToggleButton 屏蔽按键触发的功能
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void BtnMenuShow_PreviewKeyDown(object sender, KeyEventArgs e)
		{
			if (e.Key == Key.Enter) {
				e.Handled = true;
			}
		...
		private void BtnInfor_Click(object sender, RoutedEventArgs e)
		{
			...
			try {
				...
				verion = appd.CurrentVersion.ToString();
			}
			catch {
				MessageTips( name + "\r\n" + company + "\r\n" + copyright + "\r\n" + verion );
			}
