...
namespace Instrument_Control
{
	...
	public class SiglentOSC : IDisposable
	{
		...
		private decimal SiglentOSC_vReadResult( Int32 ssionRM , Int32 ssionOSC, out string error_information)
		{
			...
			Int32 viError = 0;
            viError = visa32.viRead( ssionOSC, out string Result_String, 50 );
		...
		public decimal SiglentOSC_vQueryValue( Int32 ssionRM , Int32 ssionOSC , Int32 channel , Parameter_Type parameter_type ,out string error_information)
		{
